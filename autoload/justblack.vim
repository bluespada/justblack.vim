...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#DC003E", "cterm": "204", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#D90024", "cterm": "196", "cterm16": "9" }),
      \ "green": get(s:overrides, "green", { "gui": "#6EF500", "cterm": "114", "cterm16": "2" }),
      \ "yellow": get(s:overrides, "yellow", { "gui": "#F5A136", "cterm": "180", "cterm16": "3" }),
      \ "dark_yellow": get(s:overrides, "dark_yellow", { "gui": "#DF4400", "cterm": "173", "cterm16": "11" }),
      \ "blue": get(s:overrides, "blue", { "gui": "#005ECD", "cterm": "39", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#D800CB", "cterm": "170", "cterm16": "5" }),
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#3E4452", "cterm": "59", "cterm16": "7" }),
