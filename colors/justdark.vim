...
" < https://github.com/joshdick/justblack.vim/blob/main/README.md >
" for more information.)
if !exists("g:justblack_termcolors")
  let g:justblack_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:justblack_terminal_italics")
  let g:justblack_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `justblack#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from justblack#extend_highlight
  ...
  if g:justblack_terminal_italics == 0
...
function! justblack#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! justblack#extend_highlight(group, style)
...
if get(g:, 'justblack_hide_endofbuffer', 0)
